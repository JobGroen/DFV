...
<div id="aboutme">
    <div class="container">
        <div class="row">
            <div data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-once="true" class="col-lg-6">
                <h2>Over mij</h2>
            ...
            <div class="col-lg-6">
            <?php if( !empty($aboutme) ): ?>
                <img data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-once="true" class="about-me-picture" src="<?php echo $aboutme['url']; ?>" alt="<?php echo $aboutme['alt']; ?>" />
            <?php endif; ?>
            </div>
        </div>
    </div>
